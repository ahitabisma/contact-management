...
import { deleteContact, list } from "../../lib/api/contact";
...
export default function List() {
  ...
  async function fetchContacts() {
    try {
      const response = await list(token.token, {
        name,
        email,
        phone,
        page,
      ...
      await alertError("Failed to fetch contacts. Please try again later.");
    }
  }
  ...
  async function handleContactDelete(id) {
    try {
      ...
      await alertError("Failed to delete contact. Please try again later.");
    }
  }
